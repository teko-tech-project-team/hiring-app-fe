...
import { FormEditJobseeker, FormPengalamanKerja, FormPortofolio, FormSkill } from "./FormEditJobseeker";
  ...
  return (
    <>
      ...
      <div className="w-full h-[50vh] bg-primary">
        <div className="container grid sm:grid-cols-1 md:grid-cols-12 gap-x-20 py-20 px-0 ">
          <div className="col-span-4 font-open">
            <div className="bg-white p-8 rounded-xl border-4">
              ...
              <p className="flex text-[#9EA0A5] font-semibold text-2xl">
